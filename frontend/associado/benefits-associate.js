...
(async function () {
  ...
  try {
    ...
    if (profile.membershipKind === 'AVULSO') {
      ...
      cards.innerHTML = '<p style="padding:24px;color:#718096">Benefícios de parceiros são exclusivos para sócios. Seu cadastro é avulso (paga por treino/jogo) — <a href="/public/associate-signup.html">torne-se sócio</a> para desbloquear.</p>';
      return;
    }
