...
(function () {
  const NAV = [
    { page: 'inicio', href: '/gestao/portal.html', icon: '⌂', label: 'Início' },
    { page: 'dashboard', href: '/gestao/dashboard.html', icon: '▦', label: 'Dashboard' },
    ...
    { page: 'produtos', href: '/gestao/produtos.html', icon: '⛁', label: 'Produtos & Pedidos' },
    { page: 'patrimonio', href: '/gestao/patrimonio.html', icon: '▨', label: 'Patrimônio' },
    { page: 'communication', href: '/gestao/communication.html', icon: '✦', label: 'Comunicação' },
    { page: 'tasks', href: '/gestao/tasks.html', icon: '✓', label: 'Tarefas' },
    { page: 'documents', href: '/gestao/documents.html', icon: '▤', label: 'Documentos' },
    { page: 'checkin', href: '/gestao/checkin.html', icon: '▣', label: 'Check-in' },
    { page: 'permissions', href: '/gestao/permissions.html', icon: '⚙', label: 'Permissões' },
    { page: 'warnings', href: '/gestao/warnings.html', icon: '⚠', label: 'Advertências' },
  ];
  ...
  sidebar.innerHTML = `
    <a class="shell-brand" href="/gestao/portal.html">
